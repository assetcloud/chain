...
func initBlockNode(cfg *types.ChainConfig, node *blockNode, block *types.Block, broadcast bool, pid string, sequence int64) {
	*node = blockNode{
		hash:       block.Hash(cfg),
...
func newBlockNode(cfg *types.ChainConfig, broadcast bool, block *types.Block, pid string, sequence int64) *blockNode {
	var node blockNode
