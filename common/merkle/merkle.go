...
func CalcMerkleRoot(cfg *types.ChainConfig, height int64, txs []*types.Transaction) []byte {
...
func CalcMultiLayerMerkleInfo(cfg *types.ChainConfig, height int64, txs []*types.Transaction) ([]byte, []*types.ChildChain) {
	if !cfg.IsFork(height, "ForkRootHash") {
		return nil, nil
	}
