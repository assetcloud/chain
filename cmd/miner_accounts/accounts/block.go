...
func (b chain) findBlock(ts int64) (int64, *rpctypes.Header) {
...
func (b chain) getBalance(addrs []string, exec string, height int64) (*rpctypes.Header, []*rpctypes.Account, error) {
...
func (b chain) addBlock(h *rpctypes.Header) error {
