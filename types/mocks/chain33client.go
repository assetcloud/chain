...
func (_m *ChainClient) SubEvent(ctx context.Context, in *types.ReqSubscribe, opts ...grpc.CallOption) (types.Chain_SubEventClient, error) {
	...
	var r0 types.Chain_SubEventClient
	if rf, ok := ret.Get(0).(func(context.Context, *types.ReqSubscribe, ...grpc.CallOption) types.Chain_SubEventClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.Chain_SubEventClient)
		}
	}
