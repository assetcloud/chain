...
func blockBodyCmd(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.GetBlocks", params, &res)
...
func blockHeightHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.GetBlockHash", &params, &res)
	ctx.Run()
}
...
func blockViewByHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.GetBlockOverview", params, &res)
	ctx.Run()
}
...
func lastHeader(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.GetLastHeader", nil, &res)
	ctx.Run()
}
...
func lastSequence(cmd *cobra.Command, args []string) {
	rpcLaddr, _ := cmd.Flags().GetString("rpc_laddr")
	var res int64
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.GetLastBlockSequence", nil, &res)
	ctx.Run()
}
...
func getsequences(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.GetBlockSequences", params, &res)
	//ctx.SetResultCb(parseBlockDetail)
	ctx.Run()
}
...
func getblockbyhashs(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.BlockDetails
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.GetBlockByHashes", params, &res)
...
func addPushSubscribe(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.AddPushSubscribe", &params, &res)
	ctx.Run()
}
...
func listPushes(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.ListPushes", nil, &res)
	ctx.Run()
}
...
func getPushSeqLastNumCmd(cmd *cobra.Command, args []string) {
	...
	var res types.Int64
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Chain.GetPushSeqLastNum", &params, &res)
	ctx.Run()
}
