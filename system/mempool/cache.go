...
func (cache *txCache) removeExpiredTx(cfg *types.ChainConfig, height, blocktime int64) {
	var txs []string
...
//判断交易是否过期
func isExpired(cfg *types.ChainConfig, item *Item, height, blockTime int64) bool {
